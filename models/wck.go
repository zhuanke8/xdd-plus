...
//func getOKsign(WSCK string) (*AutoGenerated, error) {
//
//	sign := getSign()
//	ptKey, _ := getOKKey1(WSCK, sign)
//
//	var count = 0
//	for {
//		count++
...
//func getKey1(WSCK string, sign *AutoGenerated) (string, error) {
//
//	ptKey, _ := getOKKey1(WSCK, sign)
//
//	var count = 0
...
//func getOKKey1(WSCK string, sign *AutoGenerated) (string, error) {
//	v := url.Values{}
//	s := sign
